...
function addItems() {
    ...
    var file = fileInput.files[0]; // Get the selected file from the input
    ...
    fd.append('file', file); // Append the file directly, using the correct field name
    ...
    $.ajax({
        ...
        contentType: false,
        success: function() {
          console.log("AJAX request success"); // Add this line to check if the AJAX request is successful
          alert('Product Added successfully.');
          $('form').trigger('reset');
          showProductItems();
        },
        error: function(xhr, status, error) {
          console.log("AJAX request error:", error); // Add this line to check for any errors in the AJAX request
        }
      });
  }
